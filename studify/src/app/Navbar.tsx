      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <h1 className="font-semibold text-white">Studify</h1>
          </div>
          {/* Desktop Menu */}
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <Link href="/features" className="text-white hover:text-gray-300 px-3 py-2 rounded-md text-sm font-medium">
                Features
              </Link>
      ...
      {isOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/features" className="text-white hover:text-gray-300 block px-3 py-2 rounded-md text-base font-medium">
              Features
            </Link>
            <Link href="/chat" className="text-white hover:text-gray-300 block px-3 py-2 rounded-md text-base font-medium">
              Sign up
            </Link>
            <Link href="#contact" className="text-white hover:text-gray-300 block px-3 py-2 rounded-md text-base font-medium">
              Login
            </Link>
          </div>
        </div>
