  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-center" style={{ marginTop: '-25vh' }}>
      ...
      <div className="text-center mb-8">
        <h1 className="text-3xl font-semibold text-black mb-6">Summarize</h1>
        <label htmlFor="options" className="block text-neutral-400">Submit a video below to summarize</label>
      </div>
