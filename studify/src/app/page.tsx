      ...
      <div className="text-center justify-center text-xl font-thin">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-5 justify-center mt-8">
          <div className="flex justify-center items-center">
            <Image src="/Harvard_University_shield.png" alt="Harvard Shield" width={85} height={85} className="object-contain"/>
          </div>
          <div className="flex justify-center items-center">
            <Image src="/MIT_logo.svg.png" alt="MIT Logo" width={85} height={85} className="object-contain"/>
          </div>
          <div className="flex justify-center items-center">
            <Image src="/block-s-right.webp" alt="Harvard Shield" width={85} height={85} className="object-contain"/>
          </div>
          <div className="flex justify-center items-center">
            <Image src="/Seal_of_University_of_California,_Berkeley.svg.png" alt="MIT Logo" width={85} height={85} className="object-contain"/>
          </div>
          <div className="flex justify-center items-center">
            <Image src="/UCLA_Bruins_script_logo.png" alt="Harvard Shield" width={85} height={85} className="object-contain"/>
          </div>
          <div className="flex justify-center items-center">
